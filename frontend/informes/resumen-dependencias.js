...
function totalR(r)      { return Number(r.total_actividades ?? r.total ?? r.actividades ?? 0) }
function analizadasR(r) { return Number(r.actividades_analizadas ?? r.analizadas ?? r.analizada ?? 0) }
