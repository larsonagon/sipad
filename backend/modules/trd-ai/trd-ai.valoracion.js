...
const KB = {
  ...
  'GESTIÓN DEL RIESGO DE DESASTRES': { ag: 2, ac: 8, disp: 'CT', vp: ['administrativo', 'legal', 'técnico'], vs: ['histórico'], cierre: 'superación de la emergencia o cierre de la vigencia del instrumento', norma: 'instrumentos del sistema municipal de gestión del riesgo, con valor evidencial permanente sobre cómo el municipio afrontó los desastres (Ley 1523 de 2012)' },
  'ATENCIÓN A VÍCTIMAS DEL CONFLICTO': { ag: 2, ac: 18, disp: 'CT', vp: ['legal', 'jurídico'], vs: ['histórico', 'testimonial'], cierre: 'reconocimiento y reparación de la víctima o cierre del expediente', norma: 'protección de los derechos de las víctimas del conflicto armado, con valor probatorio permanente y valor de memoria histórica (Ley 1448 de 2011, Ley 387 de 1997)' },
  'ATENCIÓN A POBLACIÓN VULNERABLE':   { ag: 2, ac: 8,  disp: 'S',  vp: ['administrativo', 'legal'], vs: ['histórico'], cierre: 'cierre de la atención o del período del programa', norma: 'atención a grupos vulnerables —adulto mayor, discapacidad, primera infancia— (Ley 1251 de 2008, Ley 1618 de 2013, Ley 1098 de 2006); se selecciona muestra por su valor social' },
