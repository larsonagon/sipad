...
const KB = {
  ...
  'DECLARACIONES':             { ag: 2, ac: 8,  disp: 'S',  vp: ['fiscal', 'contable', 'legal'], vs: ['estadístico'], cierre: 'firmeza de la declaración o prescripción de la obligación tributaria', norma: 'Estatuto Tributario art. 817 (prescripción 5 años); tiempos por confirmar contra la TRD convalidada de la Dirección de Rentas' },
